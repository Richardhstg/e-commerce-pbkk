                ...
                <div class="col-lg-6">
                    <div class="locations-wrap">
                        <div class="display-header">
                            <h2 class="display-7 text-uppercase text-white">Our stores</h2>
                        ...
                        <div class="location-content d-flex flex-wrap">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="content-box">
                                    <h3 class="card-title text-uppercase text-decoration-underline text-white">Indonesia
                                    </h3>
                                    <div class="contact-address pt-3">
                                        <p>Keputih, Surabaya, Indonesia</p>
                                    </div>
